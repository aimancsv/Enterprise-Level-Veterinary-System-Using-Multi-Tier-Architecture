 ...
 * 
 */
@WebServlet(name = "receptionists_ManageAppointments_EditAppointment", urlPatterns = {"/receptionists_ManageAppointments_EditAppointment"})
public class receptionists_ManageAppointments_EditAppointment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Appointments> found = appointmentsFacade.findAll();
            s.setAttribute("appointments",found);
