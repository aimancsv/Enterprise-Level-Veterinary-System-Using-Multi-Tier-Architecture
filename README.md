...
2. **User Roles and Functionalities**:
   - ![image](https://github.com/user-attachments/assets/2f6c9676-be60-4f98-9474-53f3fd7a2271)



     
   **A. Super Admin**: Manages staff accounts and oversees system operations.
   
     <img width="500" alt="Screenshot 2024-12-31 at 9 18 46 AM" src="https://github.com/user-attachments/assets/7bcf566d-bc55-43ac-9d85-f8ef77654035" />




   **B. Vets**: Registers accounts, makes diagnoses, views diagnosis history, and manages appointments.
   
     <br><br><img width="500" alt="Screenshot 2024-12-31 at 9 19 45 AM" src="https://github.com/user-attachments/assets/58f9ab56-d2f0-4506-ab50-d7fc5b20ddcb" />
     <br><br><img width="500" alt="Screenshot 2024-12-31 at 9 20 21 AM" src="https://github.com/user-attachments/assets/3f10259a-b52c-40d0-9c40-84d91b4f9354" />
   ...
   **C. Receptionists**: Creates pet and customer profiles, schedules appointments, and assigns vet consultations.
     ...
     <img width="782" alt="Screenshot 2024-12-31 at 9 21 27 AM" src="https://github.com/user-attachments/assets/762a629c-aa2b-4df6-a6fc-9af2dc227621" />
     ![image](https://github.com/user-attachments/assets/ebbe7e9d-9a65-41fa-9e67-84db41075974)
   ...
   **D. Managing Staff**: Oversees staff details, creates weekly work schedules, and accesses operational reports.
     ...
     <img width="785" alt="Screenshot 2024-12-31 at 9 22 04 AM" src="https://github.com/user-attachments/assets/9df77735-a73d-480e-8665-47282adab9ee" />
     ![image](https://github.com/user-attachments/assets/3d617411-4c8a-4bfd-9b30-1f72572c3729)
     <img width="438" alt="Screenshot 2024-12-31 at 9 22 23 AM" src="https://github.com/user-attachments/assets/58409cd0-0670-415f-b006-04902eda75ab" />



4. **Database Design**:
   - A well-structured database stores and retrieves clinic data efficiently, including staff details, pet profiles, appointments, and work schedules.
